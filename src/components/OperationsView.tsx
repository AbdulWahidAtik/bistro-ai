      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          <div className="relative w-full md:w-80">
            <span className="pointer-events-none absolute inset-y-0 left-3.5 flex items-center text-on-surface-variant/60">
              <span className="material-symbols-outlined -translate-y-px text-[18px] leading-none">
              search
              </span>
            </span>
            <input
